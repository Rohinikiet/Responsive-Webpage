...
function Header() {
     // Function to handle the click event on "Sign in"
  const handleSignInClick = () => {
    alert('Sign in clicked!'); // Replace this with your desired functionality
    // You can add any functionality you want here, such as opening a modal, navigating to another page, etc.
  };

  const handleWatchVideoClick = () => {
    window.location.href = 'https://www.youtube.com/watch?v=jprjHcRVHBg'; // Replace 'your_video_path_here' with the actual path to your video
  };
  return (
    <div className="home-page">
        <div className="div">
            ...
            <div className="text-wrapper-6" onClick={handleWatchVideoClick}>Watch the Video</div>
            ...
            <div className="text-wrapper-16" onClick={handleSignInClick}>Sign in</div>
            </div>
            </div>
            </div>
            )
